...
const addToLiked = (id) => {
    ...
    likedPostsId.push(id);  //** Problem plcae */ // Array method array.push(id)
    showPosts(posts);
};
...
const displayContent = (text) => {
    return text.length < 30 ? text  : text.slice(0, 30) + "<span class='fw-bold'>... read more</span>"; //** Problem here */
};
...
const switchTab = (id) => {
    if (id === "posts") {
        ...
        // document.getElementById( "likedPost" ) = '';
